...
### Requirement: 同 app 多触发 fire 本进程内序列化
...
#### Scenario: digest 与 poll 同刻 fire
...
#### Scenario: 活跃 run park 时 fire 降级
